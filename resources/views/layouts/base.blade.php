...
<head>
    ...
    <title>Cursos Programacion</title>
</head>
<body>
    <div class="container-fluid">
        ...
        <header class="row justify-content-center">
            <div class="col-md-10 col-sm-12 text-center text-white pt-5 pb-2">
                <h1 class="title">Cursos de Programacion</h1>
                <p>Te ofrecemos los mejores cursos de programacion en el que vas a aprender lo necesario para convertirte un programador</p>
            </div>
            @yield('banner')
        </header>
        ...
        <footer class="row justify-content-center text-start mt-3 py-5 text-white">
            ...
            <div class="col-4 text-start">
                <a href="" class="text-white text-decoration-none">© 2022 Kevin Barrios. Todos los derechos reservados.</a>
            </div>
        </footer>
    </div>
